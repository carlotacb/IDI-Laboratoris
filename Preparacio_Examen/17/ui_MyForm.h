...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(checkBox, SIGNAL(clicked(bool)), widget, SLOT(canviaCamera()));
        QObject::connect(widget, SIGNAL(activaCheck()), checkBox, SLOT(toggle()));
        QObject::connect(verticalSlider, SIGNAL(valueChanged(int)), widget, SLOT(componentRed(int)));
        QObject::connect(verticalSlider_2, SIGNAL(sliderMoved(int)), widget, SLOT(componentGreen(int)));
        QObject::connect(verticalSlider_3, SIGNAL(sliderMoved(int)), widget, SLOT(componentBlue(int)));
        QObject::connect(widget, SIGNAL(canviaRed(int)), verticalSlider, SLOT(setValue(int)));
        QObject::connect(widget, SIGNAL(canviaGreen(int)), verticalSlider_2, SLOT(setValue(int)));
        QObject::connect(widget, SIGNAL(canviaBlue(int)), verticalSlider_3, SLOT(setValue(int)));
