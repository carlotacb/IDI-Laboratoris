...
void MyGLWidget::initializeGL ()
{
  ...
  colFocus = glm::vec3(0, 1.0, 1.0); //COLOR CIAN
...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::rotate(TG, anglerotate, glm::vec3(0, 1, 0)); // AQUI GIRA GIRANDO POR TODO EL SUELO.
  TG = glm::translate(TG, glm::vec3(1, -0.375, 0));
  //TG = glm::rotate(TG, anglerotate, glm::vec3(0, 1, 0)); SI TENGO ESTA FUNCION AQUI, GIRA SOBRE SI MISMO!
...
void MyGLWidget::viewTransform ()
{
  ...
  glm::vec3 VRP1 = glm::vec3(TG*glm::vec4(VRP, 1.0));*/


  glm::mat4 View = glm::lookAt(glm::vec3(-1,1,-1), /*glm::vec3(VRP1.x, VRP1.y, VRP1.z)*/ VRP, glm::vec3(0,1,0));
  glUniformMatrix4fv(viewLoc, 1, GL_FALSE, &View[0][0]);
...
void MyGLWidget::keyPressEvent(QKeyEvent* event) 
{
  ...
  switch (event->key()) {
	...
	case Qt::Key_R: {
        ...
        glm::mat4 TG(1.f);
        glm::vec4 RotacioCamera = glm::rotate(TG, -float(M_PI/6.0), glm::vec3(0, 1, 0))*glm::vec4(VRP,1.f);
