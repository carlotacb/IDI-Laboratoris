...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        MyForm->resize(848, 726);
        widget = new MyGLWidget(MyForm);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(9, 9, 691, 708));
        ...
        layoutWidget->setGeometry(QRect(740, 0, 91, 721));
        ...
        verticalSpacer = new QSpacerItem(20, 608, QSizePolicy::Minimum, QSizePolicy::Expanding);
